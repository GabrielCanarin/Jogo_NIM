# Jogo_NIM
Tarefa de Introdução à Ciência da Computação com Python Parte 1 - Coursera 
...
alternando entre jogadas do computador e do usuário (ou seja, chamadas às duas funções anteriores).
